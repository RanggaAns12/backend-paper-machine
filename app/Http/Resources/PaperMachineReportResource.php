...
class PaperMachineReportResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            // ✅ Mapping untuk Roll Produksi
            'rolls' => $this->rolls ? $this->rolls->map(function ($roll) {
                return [
                    'id' => $roll->id,
                    'report_id' => $roll->report_id,
                    'no' => $roll->no,
                    'working_hour' => $roll->working_hour, // ✅ DITAMBAHKAN
            ...
            // Mapping untuk Downtime (Problems)
